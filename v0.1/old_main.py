...
if __name__ == "__main__":
    ...
    textures_floor = {texture[:texture.find('.')]: pygame.image.load(
        f'textures/floors/{texture}') for texture in os.listdir('textures/floors')}
    textures_ghosts = {texture[:texture.find('.')]: pygame.image.load(
        f'textures/ghosts/{texture}') for texture in os.listdir('textures/ghosts')}
    textures_icons = {texture[:texture.find('.')]: pygame.image.load(
        f'textures/icons/{texture}') for texture in os.listdir('textures/icons')}
    textures_guard = {texture[:texture.find('.')]: pygame.image.load(
        f'textures/guard/{texture}') for texture in os.listdir('textures/guard')}

    image = textures_guard['guard_front']
